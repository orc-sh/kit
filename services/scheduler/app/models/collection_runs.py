"""
Collection run model for storing individual collection execution instances.
"""
...
class CollectionRun(Base):
    ...
    # Collection execution parameters
    ...
    reports = relationship("CollectionReport", back_populates="run", cascade="all, delete-orphan")

    __table_args__ = (
        Index("idx_collection_runs_collection_id", "collection_id"),
        Index("idx_collection_runs_status", "status"),
        Index("idx_collection_runs_created_at", "created_at"),
    )
