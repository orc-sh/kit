...
def upgrade() -> None:
    ...
    op.create_index("idx_jobs_account_id", "jobs", ["account_id"], unique=False)
    op.create_table(
        "notifications",
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column("account_id", sa.String(length=36), nullable=False),
    ...
    op.create_index("idx_notifications_account_id", "notifications", ["account_id"], unique=False)
    ...
    op.create_index("idx_subscriptions_account_id", "subscriptions", ["account_id"], unique=False)
    ...
    op.create_index("idx_urls_account_id", "urls", ["account_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index("idx_urls_account_id", table_name="urls")
    op.drop_table("urls")
    op.drop_index("idx_subscriptions_status", table_name="subscriptions")
    op.drop_index("idx_subscriptions_account_id", table_name="subscriptions")
    ...
    op.drop_index("idx_notifications_account_id", table_name="notifications")
    op.drop_table("notifications")
    op.drop_index("idx_jobs_account_id", table_name="jobs")
